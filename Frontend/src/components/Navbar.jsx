          ...
          <div className="navbar">
            ...
            <div className="navbar-end">
              ...
              <label className="swap swap-rotate">
                ...
                {/* sun icon */}
                <svg
                  className="swap-off h-8 w-8 fill-current m-2"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                ...
                {/* moon icon */}
                <svg
                  className="swap-on h-8 w-8 fill-current m-2"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
              ...
              <div className="">
                <a
                  className="bg-black text-white px-3 py-2 mx-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer"
                  onClick={() =>
